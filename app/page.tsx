    ...
    <main className="min-h-screen bg-zinc-950">
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="text-center space-y-8">
          ...
          {/* Features Grid */}
          <div className=" pb-5 pt-5 grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            {[
              {
          ...
          <div className="mt-16 inline-flex items-center justify-center gap-2 bg-gray-700 px-6 py-3 rounded-full">
            <span className="text-sm font-medium text-gray-300">
              <Link href={'/pages/signup'} className="inline-flex items-center gap-2 bg-zinc-200 text-gray-900 px-8 py-4 rounded-full font-medium hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
